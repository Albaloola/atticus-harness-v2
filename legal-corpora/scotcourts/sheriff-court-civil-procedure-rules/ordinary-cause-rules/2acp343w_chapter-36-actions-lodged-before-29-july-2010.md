...
title: "2acp343w Chapter 36 Actions Lodged Before 29 July 2010"
source_file: "2acp343w_chapter-36-actions-lodged-before-29-july-2010.doc"
source_relative_path: "sheriff-court-civil-procedure-rules/ordinary-cause-rules/2acp343w_chapter-36-actions-lodged-before-29-july-2010.doc"
document_kind: rule
court: sheriff_court
...
# 2acp343w Chapter 36 Actions Lodged Before 29 July 2010
...
CHAPTER 36 ACTIONS OF DAMAGES


PART AI SPECIAL PROCEDURE FOR ACTIONS FOR, OR ARISING FROM, PERSONAL INJURIES
(Personal Injury  Actions lodged on or after 2nd November 2009 and before 29 July 2010)

36.A1	Application and interpretation of this Part
36.B1	Form of initial writ
36.C1	Actions based on clinical negligence
36.D1	Inspection and recovery of documents
36.E1	Application of other rules
36.F1	Disapplication of personal injuries procedure
36.G1	Allocation of diets and timetables
36.H1	Applications for sist or for variation of timetable
36.J1	Statements of valuation of claim
36.K1	Pre-proof conferences
36.L1	Incidental hearings

PART I INTIMATION TO CONNECTED PERSONS IN CERTAIN ACTIONS OF DAMAGES

36.1.	Application and interpretation of this Part
36.2.	Averments
36.3.	Warrants for intimation
36.4.	Applications to dispense with intimation
36.5.	Subsequent disclosure of connected persons
36.6.	Connected persons entering process
36.7.	Failure to enter process

PART II INTERIM PAYMENTS OF DAMAGES

36.8.	Application and interpretation of this Part
36.9.	Applications for interim payment of damages
36.10.	Adjustment on final decree

PART III PROVISIONAL DAMAGES FOR PERSONAL INJURIES

36.11.	Application and interpretation of this Part
36.12.	Applications for provisional damages
36.13.	Applications for further damages

PART IV MANAGEMENT OF DAMAGES PAYABLE TO PERSONS UNDER LEGAL DISABILITY

36.14.	Orders for payment and management of money
36.15.	Methods of management
36.16.	Subsequent orders
36.17.	Management of money paid to sheriff clerk

PART IVA PRODUCTIONS IN CERTAIN ACTIONS OF DAMAGES

36.17A.	Application of this Part
36.17B.	Averments of medical treatment
36.17C.	Lodging of medical reports

PART VI MESOTHELIOMA ACTIONS: SPECIAL PROVISIONS

36.19	Mesothelioma actions: special provisions
...
(7) 	Where the sheriff grants authority for the cause to proceed as an ordinary cause under paragraph (4)(a) or (6)—
	(a)	the sheriff or, as the case may be, the sheriff clerk shall sign a warrant in accordance with rule 5.1 (signature of warrants)(1);
...
(5) 	Nothing in this rule shall affect the right of a party to apply under rule 28.2 for a commission and diligence for recovery of documents or for an order under section 1 of the Administration of Justice (Scotland) Act 1972(3) in respect of any document or other property whether or not mentioned in the specification annexed to the initial writ.
...
(4) 	Despite paragraph (1), the following rules of Chapter 9 apply—
	(a)	rule 9.1 (notice of intention to defend)(4);
	(b)	rule 9.3 (return of initial writ);
	(c)	rule 9.5 (process folder);
	(d)	rule 9.6 (defences)(5); and
...
(7)	 In the application of rule 18.5(1)(a) (service of amended pleadings)(6), the sheriff shall order any timetable issued in terms of rule 36.G1 to be served together with a copy of the initial writ or record.
...
(9)	In the application of rule 19.1 (counterclaims)(7) a counterclaim may also include—
	(a)	warrants for intimation so far as permitted under these Rules; and
	(b)	a specification of documents in Form PI2.
(10) 	In rule 19.4 (disposal of counterclaims), paragraph (b) shall not apply.
(11)	 In the application of rule 20.4(3) (service on third party(8)), any timetable already issued in terms of rule 36.G1 shall also be served with a third party notice.
...
(13)	 Chapters 22 (preliminary pleas) and 28A (pre-proof hearing)(9) shall not apply.
...
(3)	 Where a party fails to comply with any requirement of a timetable other than that referred to in rule 36.K1(3), the sheriff clerk may fix a date and time for the parties to be heard by the sheriff.
...
(8B) 	The list of witnesses intimated in accordance with paragraph (1A)(g) must include the name, occupation (where known) and address of each intended witness and indicate whether the witness is considered to be a vulnerable witness within the meaning of section 11(1) of the Act of 2004(10) and whether any child witness notice or vulnerable witness application has been lodged in respect of that witness
...
(4)	 Nothing in paragraph (3) shall affect—
	...
	(b)	the right of a party to apply under rule 28.2(11) for a commission and diligence for recovery of documents or an order under section 1 of the Administration of Justice (Scotland) Act 1972(12).
...
(4) 	Rule 14.13 (procedure following grant of minute) shall not apply to a minute to which this rule applies.
...
(c) 	a person whose means and resources are such as to enable him to make the interim payment; or
(d)	 the person's liability will be met by-
(i) 	an insurer under section 151 of the Road Traffic Act 1988; or
...
(2)	 In this Part--
		"the Act of 1982" means the Administration of Justice Act 1982;
...
(4) Any sum of money invested by the sheriff clerk under this Part shall be invested in a manner in which trustees are authorised to invest by virtue of the Trustee Investments Act 1961.

PART IV A PRODUCTIONS IN CERTAIN ACTIONS OF DAMAGES

Application of this Part
36.17A.This Part applies to an action of damages for personal injuries or the death of a person in consequence of personal injuries which, by virtue of rule 36.C1 or rule 36.F1, is to proceed as an ordinary cause.
...
36.17C. (1) 	In an action to which this Part applies, the pursuer shall lodge as productions, with the initial writ when it is presented for warranting in accordance with rule 5.1, all medical reports on which he intends, or intends to reserve the right, to rely in the action.
...
36.19.	(1) 	This Part applies where liability to a relative of the pursuer may arise under section 1(2A) and (2B) of the Damages (Scotland) Act 1976 (liability where the personal injury in consequence of which the deceased died is mesothelioma)(13).
