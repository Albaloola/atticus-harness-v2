...
- Issuing authority, document type, core purpose, Most significant takeaway, Effective date or comment deadline
...
- Quote operative definitions and critical language verbatim, Flag ambiguity or discretionary interpretation with `[AMBIGUOUS]`
...
- Each safe harbor, exemption, or de minimis threshold with citation, Qualifying conditions
...
- Unclear or interpretation-dependent regulatory text, Expected future guidance or rulemaking, Issues requiring specialist follow-up
