...
Cite all testimony as **Page X, Lines Y to Z** throughout.
...
Every response must include **Page X, Lines Y to Z** references. When testimony spans multiple locations, cite all and explain relationships.
