...
|---|---|---|---|---|
| `memo-pi-tort.md` | Personal injury (premises) | `PLAYBOOK-PI-TORT` | I to X | `deposition-summary` (manager depo); `lien-resolution-summary` (Medicaid) |
| `memo-commercial-contract.md` | Commercial litigation (MSA breach) | `PLAYBOOK-COMMERCIAL-LITIGATION` | I to X | `discovery-summary` (RFP responses) |
...
- **A commercial mini-corpus.** Deferred to a follow-up pass. Contributing
  one means seeding 5 to 8 synthetic contract/correspondence documents; the
