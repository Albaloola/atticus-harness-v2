...
title: "Zdmhcnec Chapter 03 02 Oct 2023"
source_file: "zdmhcnec_chapter-03-02-oct-2023.doc"
source_relative_path: "sheriff-court-civil-procedure-rules/taxation-of-judicial-expenses-rules/zdmhcnec_chapter-03-02-oct-2023.doc"
document_kind: rule
court: sheriff_court
category: "sheriff-court-civil-procedure-rules/taxation-of-judicial-expenses-rules"
conversion: atticus-markdown-normalization-v1
---

# Zdmhcnec Chapter 03 02 Oct 2023
...
CHAPTER 3
CHARGES FOR WORK CARRIED OUT BY SOLICITORS


3.1.	  Application
3.2.	The unit
3.3.	Table of charges
3.4.	Copying and scanning
3.5.	Travel time
3.6.	Modification of inclusive charges
3.7.	Simple procedure
3.8.	Instructing and attending with counsel
3.9.	Additional charge
3.10.	Party litigants


Application
3.1. 	(1)	 Subject to rule 3.10 (party litigants), this Chapter, and the tables of charges set out in schedules 1 to 5A, apply for the purpose of determining the charges to be allowed on taxation in respect of work carried out by the entitled party’s solicitor.
...
The unit
3.2.	In this Chapter, in Chapter 8, and in schedules 1 to 5, references to a “unit” are to a measure of monetary charge with a value of £18.00.
...
(4)	Subject to rule 3.7 (simple procedure), the charges to be allowed in respect of a simple procedure case in the sheriff court(a) are those specified in the applicable table of inclusive charges in schedule 5.
...
(a)   Simple procedure was introduced by the Courts Reform (Scotland) Act 2014 (asp 18), section 72.
