...
Breach-of-contract and implied-covenant claim by Nightingale (a logistics-software vendor) against Summit (a mid-size regional 3PL) arising out of Summit's unilateral termination of a two-year Master Services Agreement with 14 months remaining on the term. Dispute centers on whether Summit's alleged service-level shortfalls satisfied the MSA's "material failure to perform" standard and whether Summit complied with the contractual 30-day cure-notice procedure. Direct damages (unpaid invoices + early-termination liquidated-damages-adjacent clause) quantifiable at **$1.12M past-due + $2.85M forward-value** with mitigation credits to be determined after source/evidence verification. Principal weaknesses: the liquidated-damages clause may be unenforceable as a penalty; Summit's RFP responses reveal documented service-level failures during Q2 to Q3 2024 that Nightingale did not timely remediate [OBJ:RFPResp §§ 4 to 9]. Preliminary recommended path: expedited mediation with anchored demand at ~$2.4M, willingness to settle at ~$1.5M-$1.9M range pre-discovery-close.
...
- **2022-08-01** - MSA executed; two-year initial term with auto-renewal, 30-day termination-for-cause procedure, 60-day termination-for-convenience on Summit's side after first anniversary (conditional on payment-in-full of remaining term value) [OBJ:MSA §§ 2.1, 10.1 to 10.2].
- **2023-08-14** - SOW-3 executed for enhanced route-optimization module; six-figure add-on [OBJ:SOW3].
- **Q1 2024** - service operating at contracted SLAs per Nightingale's monitoring [OBJ:EmailChain-A attachments 1 to 3].
...
- **2024-07-09 through 2024-09-22** - ongoing back-and-forth; Nightingale ships three patches, Summit complaints continue intermittently [OBJ:EmailChain-A msgs 7 to 24; OBJ:RFPResp §§ 4 to 7].
...
- **2024-10-14 through 2024-10-29** - Summit continues to accept services and pays invoices 2024-10-A and 2024-10-B in full [OBJ:Invoice-2024-10-A; OBJ:Invoice-2024-10-B; OBJ:EmailChain-B msgs 5 to 8].
...
|---|---|---|---|---|
| "Material failure to perform" | § 10.1(a) | Three documented patch releases + SLA compliance >97% satisfy the standard; complaints did not rise to "material" | Ongoing complaints and customer-facing incidents are per se material | [OBJ:RFPResp §§ 4 to 9]; [OBJ:EmailChain-A patch records] |
...
| Ongoing service acceptance | § 11 / UCC analog | Summit's continued use and payment through 2024-10-29 waives prior breach | No waiver; acceptance was under protest | [OBJ:Invoice-2024-10-A]; [OBJ:Invoice-2024-10-B]; [OBJ:EmailChain-B msgs 5 to 8] |

### Count I, Breach of Contract [OBJ:Complaint ¶¶ 22 to 31]

1. **Formation:** admitted [OBJ:Answer ¶4].
2. **Plaintiff performance:** three patch releases and continuous availability; SLA metrics from Nightingale's own monitoring platform [OBJ:EmailChain-A attachments 1 to 3]. **Gap:** Summit's internal SLA measurements (if any) not yet produced; RFP responses reference "customer complaint logs" but these are not SLA measurements.
...
### Count II, Breach of Implied Covenant of Good Faith [OBJ:Complaint ¶¶ 32 to 37]
...
### Counterclaim, Breach of §3.2(a) performance warranty [OBJ:Answer ¶¶ 45 to 54]
...
- **Billing / performance** - invoice series Jan 2024 to Nov 2024. Payment records support Nightingale's performance and waiver arguments.
...
|---|---|---|
| Past-due invoices | Sum Oct to Nov 2024 invoiced + fees | $1,120,000 |
| Remaining-term value (if § 10.2(b) enforceable) | MSA months 14 to 24 at contracted rate | $2,850,000 |
...
|---|---|---|---|
| Prior material breach by Nightingale | Plaintiff performance | Customer-complaint log; Summit's RFP responses [OBJ:RFPResp §§4 to 9] | Moderate; stands or falls with "material" threshold; a jury question if unresolved |
