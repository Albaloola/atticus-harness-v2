...
export class EntityAddTool implements Tool<EntityAddInput, any> {
  readonly name = 'entity_add';
  readonly description = 'Add an entity (e.g. offender, claimant, witness, client) to the matter database to track their role and breaches.';
  ...
  async call(input: EntityAddInput, context: ToolUseContext): Promise<ToolResult<any>> {
...
export function createEntityAddTool(): Tool<EntityAddInput, any> {
  return new EntityAddTool();
}
