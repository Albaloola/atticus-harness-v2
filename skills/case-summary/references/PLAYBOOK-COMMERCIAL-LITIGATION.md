...
### Defenses
Failure of condition precedent, prior material breach by plaintiff, waiver, estoppel, ratification, accord and satisfaction, force majeure, impracticability/frustration, SOL (contract SOL often 3 to 6 years; UCC 2-725 is 4 years), unclean hands, economic-loss rule, parol-evidence rule, statute of frauds, unconscionability.
...
Open with the 3 to 6 governing provisions in dispute. Quote the operative language exactly. Map each to the element it bears on.
