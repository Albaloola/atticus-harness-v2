...
|---|---|---|---|
| Design Development | to be determined | Owner approval of plans | Written |
| Permit Submission | to be determined | Applications filed | Copy to owner |
| Permit Issuance | to be determined | Permits in hand | Evidence |
| Construction Start | to be determined | Notice to proceed | Written |
| Substantial Completion | to be determined | CO or equivalent | Owner signoff |
| Final Completion | to be determined | Punch list closed | Closeout package |
...
- Set confidentiality survival at 3 to 5 years or trade-secret standard.
