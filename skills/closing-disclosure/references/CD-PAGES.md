...
| 2 | Loan costs (A to C) | Origination, lender-required services, shopped services |
| 2 | Other costs (E to H) | Government fees, prepaids, escrows, commissions, owner's title |
| 2 | Totals (D, I, J) | Subtotals and lender credits |
| 3 | Cash to close | LE vs CD comparison with change reasons |
| 3 | Summaries (K to N) | Borrower/seller transaction summaries, credits, payoffs |
