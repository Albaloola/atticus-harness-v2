...
|---|---|---|---|
| CPT Category I | AMA | 00100 to 99499 | Procedures and services with FDA-approved usage |
| CPT Category II | AMA | 0001F to 9007F | Performance measurement (informational, $0) |
| CPT Category III | AMA | 0042T to 0XXXT | Emerging technology (temporary) |
| HCPCS Level II | CMS | A0000 to V9999 | Supplies, drugs, DME, ambulance, prosthetics |
| ICD-10-CM | CDC/NCHS | A00 to Z99 | Diagnoses (3 to 7 chars, 7th char encounter type) |
| ICD-10-PCS | CMS | 7-char alphanumeric | Inpatient procedures only (UB-04) |
| MS-DRG | CMS | 001 to 999 | Inpatient facility payment grouping |
| Revenue codes | NUBC | 0001 to 9999 | UB-04 facility line items |
...
- **E/M (99202 to 99499).** Under 2021 AMA revisions, level is set by Medical Decision Making (MDM) **or** total time on date of encounter. The chart must support the chosen path.
