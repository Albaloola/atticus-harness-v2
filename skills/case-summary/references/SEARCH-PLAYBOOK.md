...
Do not brute-force every query mechanically. The loop is: query → read 3 to 10 top chunks → decide whether to follow up, to move on, or to route the cluster to a sibling skill per `ROUTING.md`.
