...
language: en
description: Drafts jurisdiction-specific petitions for expungement or sealing of criminal records. Covers caption construction, statutory eligibility analysis, rehabilitation narratives, and prayer for relief. Use when drafting expungement petitions, record-sealing motions, set-aside petitions, or certificates of rehabilitation in post-conviction proceedings. [Atticus UK/Scots refined]
tags:
...
3. Draft sections 1 to 7 in order
...
- Full legal name, address, DOB, contact information, Name change explanation if applicable, Residency status and duration, Statement confirming identity as the individual in the criminal matter, Flag if identifying info should be filed under seal per local rules
