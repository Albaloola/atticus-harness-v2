...
- Commingled accounts or no segregation of charitable funds, Remittance timing unstated, Charity lacks bank-view or reconciliation rights
...
- [ ] Statutorily required cancellation right present (commonly 10 to 15 days) [VERIFY per state]

**E. Recordkeeping & Audit**
- [ ] Vendor must maintain campaign records (commonly 3 to 7 years)
...
- [ ] Pre-solicitation filing deadlines referenced (commonly 10 to 20 days before start)
...
- Pre-solicitation filing deadlines (Notices of Intent, contract filings) are commonly 10 to 20 days before campaign start, check per state.
