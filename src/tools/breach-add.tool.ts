...
export function createBreachAddTool(): ToolDefinition<BreachAddInput> {
  return {
    id: 'breach_add',
    name: 'breach_add',
    description: 'Add a specific breach or offensive action committed by an entity (e.g. an offender), including provisions violated and citations to supporting evidence.',
    inputSchema: {
      type: 'object',
      properties: {
