...
language: en
description: Drafts an itemized Bill of Costs on Appeal under FRAP 39 or state equivalent for the prevailing party to recover allowable appellate expenses. Triggers on appellate cost bill drafting, post-judgment cost recovery filings, or prevailing party cost submissions. [Atticus UK/Scots refined]
tags:
...
- Party seeking costs and appellate role, Date of judgment entry, Authorizing rule (FRAP 39(a) or state equivalent)
...
Itemization rules:
- One line per distinct expense; multiple copies listed individually, Only claim copies required by rule, verify local rule on extras, Reference receipt/invoice number for each line, Provide category subtotals before grand total
