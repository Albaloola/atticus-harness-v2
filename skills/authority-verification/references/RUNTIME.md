...
- `jq` for the shell script follow-on steps, Python 3.9+ and the `casedev` package for the Python script, Node.js 18+ and the `casedev` package for the TypeScript script
