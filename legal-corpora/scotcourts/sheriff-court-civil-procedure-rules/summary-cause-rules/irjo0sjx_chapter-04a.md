...
title: "Irjo0sjx Chapter 04a"
source_file: "irjo0sjx_chapter-04a.doc"
source_relative_path: "sheriff-court-civil-procedure-rules/summary-cause-rules/irjo0sjx_chapter-04a.doc"
document_kind: rule
court: sheriff_court
...
# Irjo0sjx Chapter 04a

ACT OF SEDERUNT (SUMMARY CAUSE RULES) 2002 NO. 132


CHAPTER 4A 		PERSONAL INJURY PRE-ACTION PROTOCOL


4A.1	 Application and interpretation
4A.2	Requirement to comply with the Protocol
4A.3	Consequences of failing to comply with the Protocol


Application and interpretation
4A.1.	(1) 	This Chapter applies to an action of damages for, or arising from, personal injuries.
(2)	In this Chapter “the Protocol” means the Personal Injury Pre-Action Protocol set out in Appendix 1B, and references to the “aims of the Protocol”, “requirements of the Protocol” and “stages of the Protocol” are to be construed accordingly.
...
4A.3. 	(1) 	This rule applies where the sheriff considers that a party (“party A”)—
