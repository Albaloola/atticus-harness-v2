...
title: "Rjbdtgo2 Chapter 1a"
source_file: "rjbdtgo2_chapter-1a.doc"
source_relative_path: "sheriff-court-civil-procedure-rules/summary-applications-statutory-applications-and-appeals-etc-rules/rjbdtgo2_chapter-1a.doc"
document_kind: rule
court: sheriff_court
...
1A.1	Application and interpretation
1A.2	Lay representation for party litigants
...
1A.2.	 (1) 	In any proceedings in respect of which no provision as mentioned in
rule 1A.1(1) is in force, the sheriff may, on the request of a party litigant, permit a named individual (a “lay representative”) to appear, along with the litigant, at a specified hearing for the purpose of representing the litigant at that hearing.
